...
import { formatDateTime, getRelativeTimeString } from '../../../context/ScanContext';
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4'>
          ...
          <div className='flex flex-col'>
            ...
            <span className='text-xs text-indigo-400'>
              {getRelativeTimeString(scan.created_at)}
            </span>
          </div>
          <div className='flex flex-col'>
            <span className='text-sm text-indigo-500 mb-1'>Website</span>
            <span className='text-indigo-800 font-medium truncate max-w-xs'>
              {scan.website?.url || 'Not available'}
            </span>
          </div>
        </div>
